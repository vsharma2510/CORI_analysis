...
int main(int argc, char* argv[]){
  ...
  TString text_file_name = Form("/global/homes/v/vsharma2/Analysis_code/Miscalibration/Output/Bad_for_Analysis/ds%d/ds%d_bad_for_analysis_channels_alpha.txt",dataset,dataset);
